...
export const tools = [
  {
    ...
    execute: (params, context) => runResearchQuery(params, context),
  ...
  },
  {
    ...
    execute: (params, context) => runResearchEvidence(params, context),
    requiresApproval: () => false,
    isConcurrencySafe: () => true,
    isEnabled: () => true,
  },
  {
    ...
    execute: (params, context) => runJournalPalette(params),
    requiresApproval: () => false,
    isConcurrencySafe: () => true,
    isEnabled: () => true,
  },
  {
    ...
    execute: (params, context) => runResearchStatus(params, context),
    requiresApproval: () => false,
    isConcurrencySafe: () => true,
    isEnabled: () => true,
  },
